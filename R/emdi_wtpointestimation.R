...
my.point_estim <- function (framework,
                            fixed,
                            transformation,
                            interval=c(-1,2),
                            L,
  ...
  optimal_lambda <- emdi:::optimal_parameter(generic_opt    = emdi:::generic_opt,
                                             fixed          = fixed,
...
prediction_y <- function(transformation,
  ...
  y_pred <- emdi:::back_transformation(y              = y_pred,
                                       transformation = transformation,
                                       lambda         = lambda,
                                       shift          = shift
  )
