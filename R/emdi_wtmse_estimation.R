...
# my.mse_estim (only internal) ----------------------------------------------------

# The my.mse_estim function defines all parameters and estimations which have to
...
superpopulation_wild <-  function(framework, model_par, gen_model, lambda, shift,
  ...
  Y_pop_b <- emdi:::back_transformation(y              = Y_pop_b,
                                        transformation = transformation,
                                        lambda         = lambda,
                                        shift          = shift
  )
...
bootstrap_par <- function(fixed,
  ...
  Y_smp_b <- emdi:::back_transformation(y              = Y_smp_b,
                                        transformation = transformation,
                                        lambda         = lambda,
                                        shift          = shift
  )
